...
export class FichaFinancieraService {
  ...
  public url: String;
  	...
  	constructor(public _http: Http) {
		this.url = environment.urlModulosFichaFinanciera;
	...
	Get(id_empresa, cliente_ctacte, fechaDesde, fechaHasta){
		let params ="id_empresa="+id_empresa+"&cliente_ctacte="
		+cliente_ctacte+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta;
